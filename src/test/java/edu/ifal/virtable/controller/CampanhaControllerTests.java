...
class CampanhaControllerTests {
    ...
    void deveCriarCampanha() {
        ...
        ResponseEntity<Campanha> resposta =
                campanhaController.create(usuarioAutenticado, campanha);
    ...
    void deveAtualizarCampanha() {
        ...
        ResponseEntity<Campanha> resposta =
                campanhaController.update(1L, usuarioAutenticado, campanha);
    ...
    void deveListarCampanhas() {
        ...
        ResponseEntity<List<Campanha>> resposta =
                campanhaController.list();
    ...
    void deveListarUsuariosDaCampanha() {
        when(usuarioCampanhaService.listByIdCampanha(1L))
                .thenReturn(List.of());

        ResponseEntity<List<UsuarioCampanha>> resposta =
                campanhaController.listUsuarios(1L);
