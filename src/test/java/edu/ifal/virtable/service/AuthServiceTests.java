...
public class AuthServiceTests {
    ...
    void testCadastroValido() {
        ...
        assertInstanceOf(AuthSuccessResponse.class, response);
        AuthSuccessResponse successResponse = (AuthSuccessResponse) response;
    ...
    void testCadastroComEmailDuplicado() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> authService.cadastrar(request2));
